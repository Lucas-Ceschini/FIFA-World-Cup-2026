...
# Processar os dados
linhas = dados_combinacoes.strip().split('\n')
combinacoes = []
...
for linha in linhas:
    ...
    if len(partes) >= 9:
        try:
            ...
            combinacoes.append({
                "no": numero,
                "third_placed": partes[1:9]
            })
        except ValueError:
            continue

# Nome do arquivo e como salvar
nome_arquivo = "data/combinacoes.json"

# Salvar o JSON
with open(nome_arquivo, 'w', encoding='utf-8') as arquivo:
    json.dump(combinacoes, arquivo, indent=2, ensure_ascii=False)
